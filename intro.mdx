...
See [Pay mode](/sdk/modes/pay) and [Fund mode](/sdk/modes/fund) for details.
...
Trails is built by [Sequence](https://sequence.xyz), the all-in-one developer platform for web3.
