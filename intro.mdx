...
![Trails Stack](images/pop-protocol-stack.png)

## How it works

1. **Define Intent**: Create a payment transaction (mint, deposit, swap, etc) for any chain in any token.
2. **Trails Inspects**: Can this succeed with the assets held on current chain? Yes = Pass through. No = Continue Orchestrating
3. **Select Route**: Trails suggests the optimal tokens across chains — user can confirm or customize.
