...
| `tronAdapter` | `@0xtrails/tvm` | You want to accept or send payments from Tron wallets. Requires a [`Buffer` polyfill](#buffer-polyfill-for-tron) |
...
5. **Tron?** Add `tronAdapter`, plus the [`Buffer` polyfill](#buffer-polyfill-for-tron).
