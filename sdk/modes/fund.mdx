...
**At a glance**: Fund is a deposit/top-up flow (input-driven). The user typically chooses how much and what token to spend.
...
For comprehensive implementation examples including specific protocol deposits, chain funding, etc., see our [Fund Examples](@use-cases/fund) page.
