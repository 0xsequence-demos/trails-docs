...
Funding flows in Trails are modeled as exact input by default.

- "I have exactly 10 USDC tokens I want to send out from the origin chain, and I'll receive 9.99 USDC on the destination."

Users have full control over the recipient address, the amount, and the asset used.
